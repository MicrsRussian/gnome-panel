%global gettext_package gnome-panel-2.0
...
sed -i -e 's/GNOME-Flashback/X-GNOME-Flashback/' %buildroot%{_datadir}/applications/gnome-panel.desktop
...
* Tue Aug 15 2006 Alexander Larsson <alexl@redhat.com> - 2.15.91-2.fc6
...
* Fri Mar  4 2005 Mark McLoughlin <markmc@redhat.com> 2.9.91-4
- Fix a BuildRequires
...
* Mon Apr  5 2004 Mark McLoughlin <markmc@redhat.com> - 2.6.0-2
...
- panel-properties OnlyShowIn=X-X-GNOME-Flashback;
